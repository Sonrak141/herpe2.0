...
export default function Header() {
  ...
  return (
    <header className=" bg-yellow-100/20">
      <nav
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a
            href="/quienessomos"
            className=" uppercase text-md font-semibold leading-6 text-gray-900"
          >
            Empresa
          </a>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="/contactanos"
            className="bg-white py-2 px-3 rounded-md text-md font-semibold leading-6 text-gray-900"
          >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Herpe S.A.S.</span>
            </a>
            <button
              type="button"
